...
## Phase 6F Independent Review Agent Foundation

Phase 6F adds a local-only independent exact-SHA review agent foundation:
...
- automated review outside the Phase 6F trusted independent review agent
- merge, deployment, rollback, or verification agents coordinated through the Phase 6A run-state store

...
- richer Telegram/OpenClaw arbitrary text workflows beyond the approved Phase 3C text commands, Phase 5B issue approval commands, Phase 5D note approval commands, Phase 6K controlled continue command, Phase 6M read-only recover command, Phase 6O read-only run catalog commands, and Phase 6P confirmation-gated quiescent cancellation commands
- `/ppo state-promote` or any Telegram/OpenClaw project-state mutation route
- `/ppo start`, `/ppo develop`, run search, arbitrary run filters/sorts, or background autonomous-development routing

...
- richer Telegram/OpenClaw arbitrary text workflows beyond the approved Phase 3C text commands, Phase 5B issue approval commands, Phase 5D note approval commands, Phase 6K controlled continue command, Phase 6M read-only recover command, and Phase 6O read-only run catalog commands
...
- cancellation, retry, repair, resume, or other run-state mutation routes beyond the read-only Phase 6O catalog

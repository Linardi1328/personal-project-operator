...
These actions are not available in Phase 6P:
...
- `/ppo start`, `/ppo develop`, run search, arbitrary run filters/sorts, automatic recovery, repair, retry, process-interruption cancellation, cleanup, or background autonomous continuation
